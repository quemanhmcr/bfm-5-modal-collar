...
SOURCES=[
 'fea/config/tcz1l_3d_saturation_critical_surface.yml','fea/bfm5/tcz1l_3d.py','fea/scripts/run_tcz1l_3d_critical_surface.py','fea/scripts/analyze_tcz1l_3d_critical_surface.py','fea/scripts/seal_tcz1l_3d_evidence.py','fea/tests/test_tcz1l_3d.py','fea/requirements-tcz1l-core.txt','.github/workflows/tcz1l-3d-saturation.yml','.github/actions/setup-fea3d/action.yml','fea/config/tcz1k_3d_nonlinear_holdout.yml','fea/scripts/run_tcz1k_3d_nonlinear_holdout.py']
